      ...
      <div className="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow-md">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>Robots must be submitted before the round begins and can only be retrieved afterward.</li>
            <li>Robots may be programmed prior to submission; programming during a round is prohibited.</li>
            <li>Mechanical modifications after submission are not allowed. Repairs during a run must be made without tools.</li>
            <li>Only one team member may enter the arena during a round.</li>
            <li>Only team members may operate the robot; external intervention is strictly prohibited.</li>
            <li>Disrespectful behavior towards judges or teams may result in disqualification.</li>
            <li>Taunting or disruptive comments towards other teams may lead to disqualification at the judge’s discretion.</li>
            <li>The organizer reserves the right to amend rules as deemed necessary. Any amendments will be communicated clearly and in advance.</li>
            <li>Teams must have all required tools and safety equipment during the competition.</li>
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>Teams may include members from different institutions. Team sizes should remain manageable to ensure efficient coordination.</li>
            <li>A participant may only belong to one team per segment.</li>
            <li>All members must be present for certification in the arena.</li>
            <li>The team leader is responsible for team decisions and conduct.</li>
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>Robots must have an onboard power supply; wired power is prohibited.</li>
            <li>Robots must have a kill switch; programmable switches are permitted.</li>
            <li>Commercially available, pre-assembled robots are not allowed. A commercially pre-assembled robot refers to any robot that has been entirely put together and programmed by a third-party vendor.</li>
            <li>Each team must use a single robot, with no replacements allowed after the first round.</li>
            <li>No wireless communication is allowed mid-round; any breach may lead to disqualification.</li>
            <li>Voltage across any terminals must not exceed 16.8V.</li>
            <li>Robots must not damage or discolor the track. Modifications to comply may be required.</li>
            <li>Only two-wheel drive robots are allowed; four-wheel or pedal mechanisms are not.</li>
            <li>Robots may have any shape within the specified dimensions.</li>
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>Line width, node distances, and specific turns will be defined (TBD).</li>
            <li>The arena may include curved paths, sharp angles, and bonus checkpoints.</li>
            <li>Some checkpoints are mandatory; others are optional.</li>
            <li>Start and end points will be marked with black boxes (TBD dimensions).</li>
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>If still tied, the team with the fewest restarts wins.</li>
            <li>If scores remain tied, the fastest completion time for the final run will determine the winner.</li>
          </ul>
        </section>
