      ...
      <div className="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow-md">
        ...
        <section className="mb-8">
          ...
          <ul className="list-decimal pl-5 text-gray-700 mt-4">
            ...
            <li>Third Prize: 25,000 BDT</li>
            <li>4th-10th Place: 10,000 BDT each</li>
            <li>11th-20th Place: 5,000 BDT each</li>
            <li>21st-50th Place: 3,000 BDT each</li>
          </ul>
        </section>
